public class couples
{
		...
		public final int pairingq1(boys[] boyss, girls[] girlss, int nb, int ng) //!Pairing.
		{
		...
		public final int pairingq5(boys[] boyss, girls[] girlss, int nb, int ng) //!Pairing.
		{
			FILE fc = fopen("couples.txt","w+");
...
//ORIGINAL LINE: sbyte *dt = ctime(&now);
		...
		public final int mosthappy(couples[] couple, int count, int k) //!bubble sort for happiness.
		{
			...
			System.out.print("K happiest couples ");
			System.out.print("\n");
			for (int i = 0;i < count;i++)
			{
