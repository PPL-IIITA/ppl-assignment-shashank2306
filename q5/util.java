...
public class util
{
	  public final int coupling()
	  {
		...
		x = tangible.RandomNumbers.nextNumber() % 50; //!Used a rand() function to determine which function to use.
		if (x == 1)
		{
		  System.out.print("Using the logic of question 1 (generated randomly)\n");
		...
		{
		  System.out.print("Using the logic of question 5 (generated randomly)\n");
